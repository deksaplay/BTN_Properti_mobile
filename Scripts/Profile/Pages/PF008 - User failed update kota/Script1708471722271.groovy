...
Mobile.callTestCase(findTestCase('Profile/Step Definitions/User tap on preview kota'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profile/Step Definitions/User set empty kota'), [:], FailureHandling.STOP_ON_FAILURE)
