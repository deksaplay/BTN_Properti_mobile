...
Mobile.callTestCase(findTestCase('Profile/Step Definitions/User tap on preview name'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profile/Step Definitions/User set empty name'), [:], FailureHandling.STOP_ON_FAILURE)
