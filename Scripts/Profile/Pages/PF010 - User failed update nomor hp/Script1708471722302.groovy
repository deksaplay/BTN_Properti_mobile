...
Mobile.callTestCase(findTestCase('Profile/Step Definitions/User tap on preview nomor hp'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profile/Step Definitions/User set empty nomor hp'), [:], FailureHandling.STOP_ON_FAILURE)
