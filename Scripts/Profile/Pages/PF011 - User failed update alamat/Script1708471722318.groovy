...
Mobile.callTestCase(findTestCase('Profile/Step Definitions/User tap on preview alamat'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profile/Step Definitions/User set empty alamat'), [:], FailureHandling.STOP_ON_FAILURE)
